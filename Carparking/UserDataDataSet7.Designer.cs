...
namespace Carparking {
    ...
    public partial class UserDataDataSet7 : global::System.Data.DataSet {
        ...
        public partial class ResquestDbDataTable : global::System.Data.TypedTableBase<ResquestDbRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ResquestDbRow AddResquestDbRow(int IDRequest, string Type, int IDCustomer, string Name, string IDCar, string CarBrand, string Color, int IDParkRequest, string AreaRequest, System.DateTime Date) {
        ...
        public partial class ResquestDbRow : global::System.Data.DataRow {
            ...
            public string Type {
                get {
                    try {
                        return ((string)(this[this.tableResquestDb.TypeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Type\' in table \'ResquestDb\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableResquestDb.TypeColumn] = value;
                }
            }
            ...
            public bool IsTypeNull() {
                return this.IsNull(this.tableResquestDb.TypeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetTypeNull() {
                this[this.tableResquestDb.TypeColumn] = global::System.Convert.DBNull;
            }
...
namespace Carparking.UserDataDataSet7TableAdapters {
    ...
    public partial class ResquestDbTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[ResquestDb] WHERE (([IDRequest] = @Original_IDRequest) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ([IDCustomer] = @Original_IDCustomer) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_IDCar = 1 AND [IDCar] IS NULL) OR ([IDCar] = @Original_IDCar)) AND ((@IsNull_CarBrand = 1 AND [CarBrand] IS NULL) OR ([CarBrand] = @Original_CarBrand)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([IDParkRequest] = @Original_IDParkRequest) AND ((@IsNull_AreaRequest = 1 AND [AreaRequest] IS NULL) OR ([AreaRequest] = @Original_AreaRequest)) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ResquestDb] ([IDRequest], [Type], [IDCustomer], [Name], [IDCar], [CarBrand], [Color], [IDParkRequest], [AreaRequest], [Date]) VALUES (@IDRequest, @Type, @IDCustomer, @Name, @IDCar, @CarBrand, @Color, @IDParkRequest, @AreaRequest, @Date);
SELECT IDRequest, Type, IDCustomer, Name, IDCar, CarBrand, Color, IDParkRequest, AreaRequest, Date FROM ResquestDb WHERE (IDRequest = @IDRequest)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ResquestDb] SET [IDRequest] = @IDRequest, [Type] = @Type, [IDCustomer] = @IDCustomer, [Name] = @Name, [IDCar] = @IDCar, [CarBrand] = @CarBrand, [Color] = @Color, [IDParkRequest] = @IDParkRequest, [AreaRequest] = @AreaRequest, [Date] = @Date WHERE (([IDRequest] = @Original_IDRequest) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ([IDCustomer] = @Original_IDCustomer) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_IDCar = 1 AND [IDCar] IS NULL) OR ([IDCar] = @Original_IDCar)) AND ((@IsNull_CarBrand = 1 AND [CarBrand] IS NULL) OR ([CarBrand] = @Original_CarBrand)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([IDParkRequest] = @Original_IDParkRequest) AND ((@IsNull_AreaRequest = 1 AND [AreaRequest] IS NULL) OR ([AreaRequest] = @Original_AreaRequest)) AND ([Date] = @Original_Date));
SELECT IDRequest, Type, IDCustomer, Name, IDCar, CarBrand, Color, IDParkRequest, AreaRequest, Date FROM ResquestDb WHERE (IDRequest = @IDRequest)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDRequest, Type, IDCustomer, Name, IDCar, CarBrand, Color, IDParkRequest, " +
                "AreaRequest, Date FROM dbo.ResquestDb";
        ...
        public virtual int Fill(UserDataDataSet7.ResquestDbDataTable dataTable) {
        ...
        public virtual UserDataDataSet7.ResquestDbDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataDataSet7.ResquestDbDataTable dataTable = new UserDataDataSet7.ResquestDbDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataDataSet7.ResquestDbDataTable dataTable) {
        ...
        public virtual int Delete(int Original_IDRequest, string Original_Type, int Original_IDCustomer, string Original_Name, string Original_IDCar, string Original_CarBrand, string Original_Color, int Original_IDParkRequest, string Original_AreaRequest, System.DateTime Original_Date) {
            ...
            if ((Original_CarBrand == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_CarBrand));
            }
            ...
            this.Adapter.DeleteCommand.Parameters[12].Value = ((int)(Original_IDParkRequest));
            if ((Original_AreaRequest == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((string)(Original_AreaRequest));
            }
        ...
        public virtual int Insert(int IDRequest, string Type, int IDCustomer, string Name, string IDCar, string CarBrand, string Color, int IDParkRequest, string AreaRequest, System.DateTime Date) {
            ...
            if ((AreaRequest == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[8].Value = ((string)(AreaRequest));
            }
        ...
        public virtual int Update(
            ...
            if ((CarBrand == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(CarBrand));
            }
            if ((Color == null)) {
            ...
            if ((AreaRequest == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(AreaRequest));
            }
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.DateTime)(Date));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_IDRequest));
            if ((Original_Type == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_IDCustomer));
            if ((Original_Name == null)) {
            ...
            if ((Original_IDCar == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_IDCar));
            }
            if ((Original_CarBrand == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_CarBrand));
            }
            if ((Original_Color == null)) {
            ...
            if ((Original_AreaRequest == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((string)(Original_AreaRequest));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_AreaRequest, 
                    System.DateTime Original_Date) {
            return this.Update(Original_IDRequest, Type, IDCustomer, Name, IDCar, CarBrand, Color, IDParkRequest, AreaRequest, Date, Original_IDRequest, Original_Type, Original_IDCustomer, Original_Name, Original_IDCar, Original_CarBrand, Original_Color, Original_IDParkRequest, Original_AreaRequest, Original_Date);
        }
    }
