...
namespace Carparking {
    ...
    public partial class UserDataDataSet : global::System.Data.DataSet {
        ...
        public partial class UserLoginDataTable : global::System.Data.TypedTableBase<UserLoginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserLoginRow AddUserLoginRow(string Username, string Pass, int ID) {
        ...
        public partial class UserLoginRow : global::System.Data.DataRow {
            ...
            public string Pass {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Pass\' in table \'UserLogin\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsPassNull() {
                return this.IsNull(this.tableUserLogin.PassColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPassNull() {
                this[this.tableUserLogin.PassColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Carparking.UserDataDataSetTableAdapters {
    ...
    public partial class UserLoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[UserLogin] WHERE (((@IsNull_Username = 1 AND [Username] IS NUL" +
                "L) OR ([Username] = @Original_Username)) AND ((@IsNull_Pass = 1 AND [Pass] IS NU" +
                "LL) OR ([Pass] = @Original_Pass)) AND ([ID] = @Original_ID))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UserLogin] ([Username], [Pass], [ID]) VALUES (@Username, @Pass" +
                ", @ID);\r\nSELECT Username, Pass, ID FROM UserLogin WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserLogin] SET [Username] = @Username, [Pass] = @Pass, [ID] = @ID WHERE (((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Pass = 1 AND [Pass] IS NULL) OR ([Pass] = @Original_Pass)) AND ([ID] = @Original_ID));
SELECT Username, Pass, ID FROM UserLogin WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Pass, ID FROM dbo.UserLogin";
        ...
        public virtual int Fill(UserDataDataSet.UserLoginDataTable dataTable) {
        ...
        public virtual UserDataDataSet.UserLoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataDataSet.UserLoginDataTable dataTable = new UserDataDataSet.UserLoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataDataSet.UserLoginDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Username, string Original_Pass, int Original_ID) {
        ...
        public virtual int Insert(string Username, string Pass, int ID) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Pass, int ID, string Original_Username, string Original_Pass, int Original_ID) {
            if ((Username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Pass, string Original_Username, string Original_Pass, int Original_ID) {
